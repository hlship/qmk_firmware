         ...
         (binding [*out* (io/writer file)]
           (keymaps (merge (map-invert key*)
                    ...
                    ;; Layer 3: Cursive/IntelliJ
                    {
                     ...
                     :k1b (alt-gui :up)                     ; [up] - previous occurance (search)
                     :k1a (alt-gui :down)                   ; [down] - next occurance (search)
                     (key y) (ctrl-shift :j)                ; join lines
                     :k13 (gui-shift :up)                   ; move form up
                     :k19 (gui-shift :up)
                     :k1c (gui-shift :down)                 ; move form down
                     :k14 (gui-shift :down)
                     }
                    )))
